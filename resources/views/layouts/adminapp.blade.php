...
<nav class="navbar navbar-expand-lg navbar-dark default-color">
  <a class="navbar-brand">
    <img src="{{ asset('public/logo.png')}}" height="50" class="d-inline-block align-top"
      alt="EWUCoPC logo"><span class="text-white font-weight-bold"><b> East West University Computer Programming club / ADMIN </b></span><br>
  </a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent-333">
    ...
    <ul class="navbar-nav ml-auto nav-flex-icons">
      ...
      @else
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('adminhome')}}">Index</a>
          </li>
          <li class="nav-item">
