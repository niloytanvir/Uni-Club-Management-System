...
<div style="background-image: url('{{ asset('public/bg/4584.jpg')}}'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
          ...
          <br>
            ...
            <div class="card">
                <div class="card-header"> <strong> Recruitment </strong></div>
                <div class="card-body">
                    @if (session('status'))
                        <div class="alert alert-success" role="alert">
                            {{ session('status') }}
                    ...
                    <a href="{{action('HomeController@userreqruitment', $id=Auth::user()->id)}}"> Request for recruitment <a/>
